...
public class AdapterUsers extends RecyclerView.Adapter<AdapterUsers.MyHolder>{
    ...
    public void onBindViewHolder(@NonNull MyHolder myHolder, int i) {
       ...
       final String userEmail = userList.get(i).getEmail();
        ...
        myHolder.blockIv.setImageResource(R.drawable.ic_baseline_check_circle_24);
                ...
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        for(DataSnapshot ds: snapshot.getChildren()){
                            if(ds.exists()){
                                Toast.makeText(context, "You're blocked by the user, can't see the message", Toast.LENGTH_SHORT).show();
                                return;
                            }
                        }
        ...
        ref.child(myUid).child("BlockedUsers").orderByChild("uid").equalTo(hisUID)
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        for(DataSnapshot ds: snapshot.getChildren()){
                            if(ds.exists()){
                                myHolder.blockIv.setImageResource(R.drawable.ic_baseline_block_24);
